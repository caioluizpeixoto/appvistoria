  ...
  Future<String?> generateLaudoCompleto({
    ...
    try {
      ...
      if (decodedImage != null) {
        ...
        marcaAguaBw = pw.MemoryImage(Uint8List.fromList(bwBytes));
      }
    } catch (_) {}
        ...
        children: [
          ...
          pw.Container(
            ...
            child: logo != null
                ...
                : pw.Center(
                    child: pw.Text('Logo',
                        style: pw.TextStyle(color: _kGreyDark, fontSize: 10))),
          ),
                                  ...
                                  children: [
                                    pw.Expanded(
                                        child: pw.Column(
                                            ...
                                            children: [
                                          _buildKv(
                                              'PLACA:', veiculo.placa, styles),
                                          _buildKv(
                                              'MARCA:', veiculo.marca, styles),
                                          _buildKv('MODELO:', veiculo.modelo,
                                              styles),
                                          _buildKv(
                                              'ANO FAB/MOD:',
                                    ...
                                    pw.Expanded(
                                        child: pw.Column(
                                            ...
                                            children: [
                                          _buildKv('Nº CHASSI:',
                                              veiculo.chassiVeiculo, styles),
                                          _buildKv('Nº MOTOR:',
                                              veiculo.motorVeiculo, styles),
                                          _buildKv('COMBUSTÍVEL:',
                                              veiculo.combustivel, styles),
                                          _buildKv('QUILOMETRAGEM:',
                                              veiculo.km?.toString(), styles),
                                          _buildKv('MUNICÍPIO:',
                                              veiculo.municipio, styles),
                                        ])),
                                  ]),
                            ]),
                      ),
